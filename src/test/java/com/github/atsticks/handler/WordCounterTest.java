package com.github.atsticks.handler;

import com.amazonaws.serverless.proxy.internal.testutils.MockLambdaContext;
import com.amazonaws.serverless.proxy.model.ApiGatewayRequestContext;

import com.github.atsticks.handler.wordcount.WordCounter;
...
/**
 * Tests for {@link WordCounter}. Modify the tests in order to support your use case as you build your project.
 */
...
public class WordCounterTest {
    ...
    /**
     * Basic test to verify the result obtained when calling {@link WordCounter} successfully.
     */
    @Test
...
//        WordCounterResponse response = (WordCounterResponse) new WordCounter().handleRequest(input.toString(), mockLambdaContext);
//
...
//        WordCounterResponse response = (WordCounterResponse) new WordCounter().handleRequest(input, mockLambdaContext);
//
//        assertEquals(response.getStatusCode(), 200);
//        JSONObject result = new JSONObject(response.getBody());
